...
- [消防救急デジタル無線受信アプリ]({{site.baseurl}}assets/files/t61-fire-dept-receiver-1.0.5.zip)
...
5. [「消防救急デジタル無線受信アプリ」をダウンロード]({{site.baseurl}}assets/files/t61-fire-dept-receiver-1.0.5.zip)して適当な場所に ZIP ファイルを展開
